...
**Commit cadence (required, repo-wide):**

- Any time files are changed in this repository (app, backend, infrastructure, docs, or tests), create a commit before ending the work session.
