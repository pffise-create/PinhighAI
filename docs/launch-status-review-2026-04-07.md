...
- 🟡 **CloudWatch alarms:** In progress; baseline CloudWatch alarm stack template and deployment commands added.
- 🟡 **CI regression automation:** In progress; GitHub Actions workflow added for Jest + Expo export checks.
...
- CI regression automation has started (GitHub Actions workflow added) and now needs branch protection + required-check enforcement.
